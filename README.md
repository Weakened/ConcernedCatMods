...
| [Concerned Teamster](docs/mods/concerned-teamster/PROJECT.md) | v1.0.0 stable release candidate sealed, pending owner publish approval | Cart truth: measures cart load, grade, traction, and hauling risk, and scores road quality from recorded trips — while vanilla cart physics stay untouched by default. |
