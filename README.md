...
| Mod | Status | Purpose |
|---|---|---|
| [Concerned Cartographer](docs/mods/concerned-cartographer/PROJECT.md) | v1.2.2 Meet Hulgi | A living atlas: self-mapping roads, durable managed pins, search and decluttering, road-aware routes, optional walking and sailing Route Follow, and explicit collaborative sharing on Valheim's map. |
