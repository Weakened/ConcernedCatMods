...
internal static class AtlasStrings
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["companion.compass.prompt"] = "A broken compass lies here. Press [{0}] to examine it.",
        ["companion.hulgi.joinedCrew"] = "Hulgi joined your crew",
        ["companion.door.allow"] = "Let companions use this door",
        ["companion.door.stop"] = "Keep companions away from this door",
        ["companion.door.stateAllowed"] = "Companions may use this door",
        ["companion.door.stateDenied"] = "Companions keep away from this door",
        ["companion.door.allDoors"] = "Companions may use this door, like every door (Companions → DoorAccess)",
        ["companion.door.nowAllowed"] = "Companions may use this door now.",
        ["companion.door.nowDenied"] = "Companions will keep away from this door.",
        ...
        // CC-NPC-005 - Hulgi's authored lines. Roughly a third are sincere:
        // the cat is somebody he misses, not a running gag. No line names a
        // boss, a weakness, an item or a place, and every biome line is gated
        // behind that biome being known to THIS character.
        ["hulgi.greet.back"] = "You came back. Good. Never gets old, that.",
        ["hulgi.greet.speech"] = "There you are. I was starting to compose a speech.",
        ["hulgi.greet.upright"] = "Still upright. That is most of it.",
        ["hulgi.greet.sit"] = "Sit a moment. The map will keep.",
        ["hulgi.greet.quiet"] = "Quiet here. I have got used to it. Mostly.",
        ["hulgi.cat.weather"] = "My cat always knew when the weather would turn. I mistook his judgement for laziness. Concerning, in hindsight.",
        ["hulgi.cat.essential"] = "A warm fire, dry boots, and a cat. We are still short one essential.",
        ["hulgi.cat.wind"] = "He would have hated it here. Too much wind. He would have stayed anyway.",
        ["hulgi.cat.ship"] = "I named him after a ship. He outlived it.",
        ["hulgi.cat.noticed"] = "Home is wherever somebody notices you did not come back.",
        ["hulgi.cat.tidier"] = "You keep a tidier camp than I did. Not a high bar. Still.",
        ["hulgi.cat.late"] = "Whoever fed him after I left, I hope they were late once or twice. He would have wanted the routine.",
        ["hulgi.cat.supper"] = "Four paws, no patience, and a very exact idea of when supper was.",
        ["hulgi.travel.markhome"] = "Mark the way home before you need it. Pride makes a poor landmark.",
        ["hulgi.travel.turnback"] = "A map tells you where you are. Knowing when to turn back is your department.",
        ["hulgi.travel.wayout"] = "Before you plan the way out, mark the way home.",
        ["hulgi.travel.compass"] = "No, the compass still does not work. I am trying to be useful in its place.",
        ["hulgi.travel.twoshort"] = "Two short trips beat one you do not finish.",
        ["hulgi.travel.shortest"] = "The shortest route and the one you survive are not always the same line.",
        ["hulgi.travel.morning"] = "Leave in the morning. I say that to everyone. Everyone leaves at dusk.",
        ["hulgi.travel.weight"] = "Whatever you are carrying, you will want it less at the halfway point.",
        ["hulgi.weather.turned"] = "Wind has turned. That used to mean something to me. It still does. I just cannot do anything about it.",
        ["hulgi.weather.cold"] = "Rain first, then the cold. It is the cold that gets the careless.",
        ["hulgi.weather.loan"] = "Clear sky. Take it as a loan, not a gift.",
        ["hulgi.weather.calm"] = "I stopped trusting a calm sea some time ago. Professionally.",
        ["hulgi.weather.prophet"] = "Storm coming. Or not. I am a cartographer, not a prophet.",
        ["hulgi.weather.fog"] = "Fog flattens a coastline into a rumour. Go slowly.",
        ["hulgi.biome.meadows"] = "The meadows are kind. That is how they talk you into wandering.",
        ["hulgi.biome.blackforest"] = "In the black forest, listen more than you look.",
        ["hulgi.biome.swamp"] = "The swamp is wet, dark, and full of opinions. Take a light, and a spare light.",
        ["hulgi.biome.mountain"] = "The mountain does not get you with the drop. It is the cold, and it is patient.",
        ["hulgi.biome.plains"] = "Open ground cuts both ways out there. If you can see far, so can they.",
        ["hulgi.biome.ocean"] = "The sea is honest. It never once pretended to be safe.",
        ["hulgi.biome.mistlands"] = "The mist takes your distances first and your bearings second. Mark where you went in.",
        ["hulgi.biome.ashlands"] = "Everything there is either burning or about to. Plan the way out first.",
        ["hulgi.biome.deepnorth"] = "Cold enough that mistakes stop being survivable. Do not linger.",

        ["companion.talkVerb"] = "Talk",
