...
/// <remarks>Copied verbatim from the proven adapter Concerned Cartographer
/// wrote for #307 and Concerned Foreman carries. Products never reference each
/// other and shared source may not contain game types, so the copy is
/// deliberate (docs/settlement/cart-and-collection/DECISIONS.md D2). Any fix to
/// the constructor-shape logic belongs in all three copies; there is no fourth
/// place it could live without breaking one of those two rules.</remarks>
