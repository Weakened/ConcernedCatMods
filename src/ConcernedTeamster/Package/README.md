...
**Stable 1.0.4 patch release by The Concerned Cat.**
...
* Version 1.0.4 is a version-alignment rebuild of the stable 1.0.2 maintenance patch, with no functional changes since 1.0.2. Future work focuses on Valheim compatibility, reported bugs, reliability, and calibration informed by real hauling feedback; new gameplay features are tracked separately.
