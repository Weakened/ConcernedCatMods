...
**Stable 1.0.5 release by The Concerned Cat.**
...
* **Container permissions for Gunnar (#374, unreleased).** Look at a chest, press F9 (`Workers/ContainerPermissionShortcut`), and choose what he may do with it: nothing, take, deposit, or both. Every container starts at nothing, and your choices are kept per world beside Teamster's other files rather than in the world. Nothing consumes them yet — the transfer that will is still being built.
...
* Version 1.0.5 adds Gunnar, an opt-in worker who pulls a cart you explicitly assign to him. He is off by
  default under `Workers/GunnarHaulingEnabled`, and with the setting off nothing about hauling changes.
  Everything the mod measured before it is unchanged: vanilla cart physics stay untouched by default.
