...
/// <remarks>Copied from Concerned Cartographer's proven adapter (#307). Products never
/// reference each other and shared source may not contain game types, so the
/// copy is deliberate (docs/settlement/cart-and-collection/DECISIONS.md D2).</remarks>
